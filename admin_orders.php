...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <p> gebruikersnaam : <span><?php echo $fetch_orders['user_id']; ?></span> </p>
         ...
         <p> dres : <span><?php echo $fetch_orders['address']; ?></span> </p>
         <p> totaal producten : <span><?php echo $fetch_orders['total_products']; ?></span> </p>
         ...
         <form action="" method="post">
            ...
            <a href="admin_orders.php?delete=<?php echo $fetch_orders['id']; ?>" class="delete-btn" onclick="return confirm('deze bestelling verwijderen?');">verwijder</a>
         </form>
      </div>
      <?php
         }
